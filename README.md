...
* **Responsive UI:** Clean, easy-to-use interface built to look great on both desktop and mobile devices.
##  Tech Stack
...
```bash
   git clone https://github.com/mahmad031204-bool/heart-disease-app.git](https://github.com/mahmad031204-bool/heart-disease-app.git)
